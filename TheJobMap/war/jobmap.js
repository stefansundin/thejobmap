...
var jobmap = {
	...
	updateUserForm: function() {
		...
		$('<p>Upload CV (only pdf, maximum size is 1 MB): </p>').append($('<iframe src="/upload-cv.html" id="cvIframe" width="200" height="25" scrolling="no" frameborder="0"></iframe>')).appendTo('#updateUserForm');
